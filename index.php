...
<body>
        ...
        <div class="container"> 
            ...
            <!-- start top-navbar -->
                <div class="top-navbar">
                    ...
                    <!-- start Title -->
                    <div class="title">
                            <a href="#"><img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="google logo"></a>
                    ...
                    <div class="google_log">
                        <button class="menu"><i class="fas fa-ellipsis-h"></i></button>
    ...
    <main>
        ...
        <?php foreach ($faq as $element) { ?>
            ...
            <?php foreach ($element['answer'] as $a) { ?>
                <p> <?php echo $a ?></p>
